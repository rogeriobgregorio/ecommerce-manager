...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(SecurityFilterConfig securityFilterConfig, ErrorHandler errorHandler) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) {
        ...
        return errorHandler.catchException(() -> {
                    httpSecurity.cors(Customizer.withDefaults())
                            ...
                            .build();
                    return null;
                }, "Error during execution of the 'cors' method"
        );
    }
    ...
    public AuthenticationManager authenticationManager(AuthenticationConfiguration authenticationConfiguration) {
        ...
        return errorHandler.catchException(authenticationConfiguration::getAuthenticationManager,
                "Error during execution of the 'getAuthenticationManager' method"
        );
    }
