        ...
        try {
            return httpSecurity
                    ...
                    .authorizeHttpRequests(authorize -> authorize
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/v1/pix/evp").hasAnyRole("ADMIN", "MANAGER")
                            .requestMatchers(HttpMethod.GET, "/api/v1/pix/charge").hasAnyRole("ADMIN", "MANAGER")
                            .requestMatchers(HttpMethod.GET, "/api/v1/pix/qrcode").hasAnyRole("ADMIN", "MANAGER")
