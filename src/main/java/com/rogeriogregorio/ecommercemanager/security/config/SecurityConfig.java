        ...
        try {
            return httpSecurity
                    ...
                    .authorizeHttpRequests(authorize -> authorize
                            ...
                            .requestMatchers(HttpMethod.POST, "/api/v1/email/password-reset").permitAll()
                            .requestMatchers(HttpMethod.PUT, "/api/v1/email/password-reset").hasAnyRole("ADMIN", "MANAGER")
                            .requestMatchers(HttpMethod.POST, "/api/v1/webhook/pix").permitAll()
                            .requestMatchers(HttpMethod.POST, "/api/v1/webhook").permitAll()
                            .requestMatchers(HttpMethod.GET, "/api/v1/pix/charges/search").hasAnyRole("ADMIN", "MANAGER")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/addresses/{id}").hasAnyRole("ADMIN", "MANAGER", "CLIENT")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/categories/{id}").hasAnyRole("ADMIN", "MANAGER")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/orders/{id}").hasAnyRole("ADMIN", "MANAGER", "CLIENT")
                            .requestMatchers(HttpMethod.PATCH, "/api/v1/orders/status/{id}").hasAnyRole("ADMIN", "MANAGER")
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/v1/orders/client/{id}").hasAnyRole("ADMIN", "MANAGER", "CLIENT")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/order-items/{id}").hasAnyRole("ADMIN", "MANAGER", "CLIENT")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/products/{id}").hasAnyRole("ADMIN", "MANAGER")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/stock-movements/{id}").hasAnyRole("ADMIN", "MANAGER")
                            .requestMatchers(HttpMethod.DELETE, "/api/v1/stock-movements/{id}").hasRole("ADMIN")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/users/{id}").hasAnyRole("ADMIN", "MANAGER", "CLIENT")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/discount-coupons/{id}").hasAnyRole("ADMIN", "MANAGER")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/notifications/{id}").hasAnyRole("ADMIN", "MANAGER")
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/product-discounts/{id}").hasAnyRole("ADMIN", "MANAGER")
